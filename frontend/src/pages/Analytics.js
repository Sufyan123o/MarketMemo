    ...
    if (loading) {
        return (
            <Container maxWidth="xl" sx={{ py: 4 }}>
                <Typography variant="h4" sx={{ color: '#36D1DC', fontWeight: 700, mb: 3 }}>
                    Loading Analytics...
                </Typography>
                <LinearProgress />
            </Container>
                ...
                <Box sx={{ display: 'flex', gap: 2 }}>
                    ...
                    <Button
                        ...
                        sx={{ 
                            color: '#5B86E5', 
                            borderColor: '#5B86E5',
                            '&:hover': { borderColor: '#36D1DC', backgroundColor: 'rgba(91, 134, 229, 0.1)' }
                        }}
                    >
                        Refresh
                    </Button>
                ...
                <Grid container spacing={3} sx={{ mb: 4 }}>
                    <Grid item xs={12} sm={6} md={3}>
                        <Card sx={{ 
                            ...
                            <CardContent sx={{ textAlign: 'center' }}>
                                <Timeline sx={{ color: '#36D1DC', fontSize: 40, mb: 1 }} />
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <Card sx={{ 
                            ...
                            <CardContent sx={{ textAlign: 'center' }}>
                                <ShowChart sx={{ color: '#36D1DC', fontSize: 40, mb: 1 }} />
                                <Typography variant="h6" sx={{ color: 'white', fontWeight: 600 }}>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                        <Card sx={{ 
                            ...
                            <CardContent sx={{ textAlign: 'center' }}>
                                <Upload sx={{ color: '#5B86E5', fontSize: 40, mb: 1 }} />
                                <Typography variant="h6" sx={{ color: 'white', fontWeight: 600 }}>
                ...
                <CardContent>
                    ...
                    <TableContainer>
                        <Table>
                            <TableHead>
                                <TableRow>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Date</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Symbol</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Side</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Quantity</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Price</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Value</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>P&L</TableCell>
                                    <TableCell sx={{ color: 'rgba(255, 255, 255, 0.7)', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.1)' }}>Source</TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                                {allTrades.slice(0, 50).map((trade, index) => {
                                    ...
                                    return (
                                        <TableRow key={trade.trade_id || index} sx={{ '&:hover': { bgcolor: 'rgba(255, 255, 255, 0.05)' } }}>
                                            ...
                                            <TableCell sx={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                                <Chip
                                                    ...
                                                    sx={{
                                                        ...
                                                        fontWeight: 600,
                                                        border: `1px solid ${(trade.side === 'BUY' || trade.action === 'buy') ? '#4CAF50' : '#f44336'}`
                                                    }}
                                                />
                                            </TableCell>
                                            <TableCell sx={{ color: 'white', borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                            ...
                                            <TableCell sx={{ color: realizedPnL >= 0 ? '#4CAF50' : '#f44336', fontWeight: 600, borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                            ...
                                            <TableCell sx={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                                                <Chip
                                                    ...
                                                    size="small"
                                                    sx={{
                                                        bgcolor: isImported ? 'rgba(91, 134, 229, 0.2)' : 'rgba(54, 209, 220, 0.2)',
                                                        color: isImported ? '#5B86E5' : '#36D1DC',
                                                        fontWeight: 600,
                                                        border: `1px solid ${isImported ? '#5B86E5' : '#36D1DC'}`
                                                    }}
                                                />
                                            </TableCell>
                                        </TableRow>
                ...
                <DialogActions sx={{ p: 3 }}>
                    ...
                    <Button
                        ...
                        sx={{ 
                            ...
                            '&:hover': { background: 'linear-gradient(135deg, #5B86E5 0%, #36D1DC 100%)' }
                        }}
                    >
